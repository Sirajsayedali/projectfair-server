const projects = require('../Database/model/projectSchema')
...
exports.getAllProject = async(req,res)=>{
    ...
    const query = {
        language:{
            //I- based on which search has to be executed
            //II- to remove case sensitivity
 ...
 exports.editUserProject = async(req,res)=>{
    ...
    console.log(title, language, github, website, overview,projectImage);
     ...
     try {
        ...
        const updateProject = await projects.findByIdAndUpdate({_id:projectId},{title,language,github,website,overview,projectImage:uploadedprojectImage,userId},{new:true}) //new value to existing content
